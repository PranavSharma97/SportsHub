...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_LOGIN_TABLE = "CREATE TABLE " + TABLE_USER + "("
                ...
                + KEY_EMAIL + " TEXT UNIQUE," + KEY_USERNAME + " TEXT UNIQUE,"
                + KEY_GENDER + " TEXT," + KEY_CONTACT_NO + " TEXT,"
                + KEY_AGE + " INTEGER,"
                + KEY_UID + " TEXT,"
                + KEY_CREATED_AT + " TEXT" + ")";
     ...
     * */
    public void addUser(String name, String email, String username, String gender, String contact_no, int age, String uid, String created_at) {
        ...
        values.put(KEY_CONTACT_NO, contact_no);
...
//        db.close(); // Closing database connection
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        if (cursor.getCount() > 0) {
            ...
            user.put("contact_no", cursor.getString(5));
